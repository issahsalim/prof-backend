...
SECRET_KEY = 'django-insecure-vyhk6x(&pg)$xnjh_$$&*!20&yo@zd4l&nr12v2p^w8(@z#mtl'
...
# Email (contact form) 
# For testing: emails are printed to the console (where you run runserver)
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
# SMTP settings (used when you switch to smtp.EmailBackend for production)
